                ...
                <x-slot name="content">
                    ...
                    <x-containers.formbody :bg="true">
                        ...
                        <x-slot name="input">
                            ...
                            <x-forms.error for="product.name"/>
                        </x-slot>
                    ...
                    <x-containers.formbody>
                        ...
                        <x-slot name="input">
                            ...
                            <x-forms.error for="product.barcode"/>
                        </x-slot>
                    </x-containers.formbody>
                    {{--Category--}}
                    <x-containers.formbody :bg="true">
                        ...
                        <x-slot name="input">
                            ...
                            <x-forms.error for="product.category_id"/>
                        </x-slot>
                    </x-containers.formbody>
                    {{--Sub Category--}}
                    <x-containers.formbody>
                        ...
                        <x-slot name="input">
                            ...
                            <x-forms.error for="product.subcategory_id"/>
                        </x-slot>
                    </x-containers.formbody>
                    {{--Trademark--}}
                    <x-containers.formbody :bg="true">
                        ...
                        <x-slot name="input">
                            ...
                            <x-forms.error for="product.trademark_id"/>
                        </x-slot>
                    </x-containers.formbody>
                    {{--Description--}}
                    <x-containers.formbody>
                        ...
                        <x-slot name="input">
                            ...
                            <x-forms.error for="product.description"/>
                        </x-slot>
                    </x-containers.formbody>
                    {{--Variations--}}
                    ...
                    @foreach($this->attributes as $key => $attribute)
                        <x-containers.formbody class="border-t border-gray-300">
                            ...
                            <x-slot name="input">
                                <x-component.dropdown-input :datos="$atrivute_values" :columna="'type'" wire:model="attributes.{{$key}}.type">
                                    ...
                                    <x-forms.error for="attributes.{{$key}}.type"/>
                        ...
                        <x-containers.formbody>
                            ...
                            <x-slot name="input">
                                ...
                                <x-forms.error for="attributes.{{$key}}.value"/>
                            </x-slot>
                        </x-containers.formbody>
